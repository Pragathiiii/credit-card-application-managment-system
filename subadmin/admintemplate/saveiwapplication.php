...
<body>
<div><h3>List Of Applications</h3><div>
    <?php
        if($c>0)
        {
            ?>
    ...
    {
        echo "<tr>";
        $appno=$app_array[$i]["appno"];
        $aadharno=$app_array[$i]["aadharno"];
        echo "<td class='linkk'><a href=viewcibil.php?appno=$appno&aadharno=$aadharno >".$app_array[$i]["appno"]."</td>";
        ...
        echo "<td><img src=../../".$app_array[$i]["pan"]." height=50 width=50></td>";
        echo "<td><img src=../../".$app_array[$i]["aadhar"]." height=50 width=50></td>";
