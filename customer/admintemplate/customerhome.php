...
<body>
    ...
    <table border=1 align=center class="table">
     ...
     <td><?php echo $app_array[0]["appno"];?> </td>
        ...
        <td><h4 style= font-weight:600;font-size:21px;>Credit Score Range:</td><td><br> i. 560 to 739 - Fair <br>ii. 740 to 799 - Good <br>iii. 800 to above - Excellent <br>Applicants below 660 credit score are not Eligible </h4></td></tr>
        
        <tr><td style="border: none;"><h6 align="center"><a href="feedbackform.php" class="linkk">Give Feedback</a></h6></td>
    </tr>
    </thead>
